...
RUN . /opt/bitnami/scripts/libcomponent.sh && component_unpack "postgresql" "13.4.0-4" --checksum bbbc806929333dc0ecbf8c3544a2764e68fcd6b702b9747ff5d8c7081d8c0226
...
ENV BITNAMI_APP_NAME="postgresql" \
    BITNAMI_IMAGE_VERSION="13.4.0-debian-10-r53" \
    LANG="en_US.UTF-8" \
    LANGUAGE="en_US:en" \
